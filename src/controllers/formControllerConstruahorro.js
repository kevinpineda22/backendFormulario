...
export async function saveFormDataConstruahorro(req, res) {
  ...
  try {
    const { data, error } = await supabase
      .from("sociodemografico_construahorro")
      .insert([dataToInsert]);
...
export async function listFormDataConstruahorro(req, res) {
  try {
    const { data, error } = await supabase
      .from("sociodemografico_construahorro")
      .select("*");
...
export async function updateFormDataConstruahorro(req, res) {
  const { id } = req.params;
